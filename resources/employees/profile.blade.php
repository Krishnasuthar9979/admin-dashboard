    ...
    <div class="container py-5">
        <div class="card shadow mx-auto profile-card">
            ...
            <div class="card-body">
                ...
                <!-- <img src="{{ url('storage/image.png') }}" 
                alt="Admin Profile" class="profile-image rounded-circle mb-3"> -->
                    <h5 class="card-title">{{ $employee->e_name }}</h5>
                </div>
                ...
                <div class="profile-info">
                    ...
                    <div class="info-item">
                        ...
                        <span>+{{ $employee->e_contact }}</span>
                    </div>
                    <div class="info-item">
                    <i class="bi bi-phone"></i>
                    <label class="fw-bold">My Schedule:</label>
                        <span>{{ $employee->schedule }}</span>
                    </div>
                    <div class="info-item">
                    <i class="bi bi-lock"></i>
                    <label class="fw-bold">Joining:</label>
                        <span>{{ $employee->j_date }}</span>
                    </div>
                    <button class="btn btn-sm btn-primary me-1" style="text-align:center; padding:10px; width:30%; margin-left :78%;">
                        <i class="bi bi-pencil"> <a href="/employees/empedit/{{$employee->e_id}}" style="color:white;">
                                edit
                            </a>
                        </i>
                    </button>
    ...
    <script>
        function togglePassword() {
            ...
            if (passwordSpan.textContent === '••••••••') {
                passwordSpan.textContent = '{{ $employee->e_password }}'; // This would normally come from your database
            } else {
